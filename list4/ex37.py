...
if __name__ == "__main__":
    ...
    print("Jaccard similarity between text1 and text2:", minhash_S1.jaccard(minhash_S2))
    print("Jaccard similarity between text2 and text3:", minhash_S2.jaccard(minhash_S3))
    print("Jaccard similarity between text1 and text3:", minhash_S1.jaccard(minhash_S3))
